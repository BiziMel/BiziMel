...
8. Open `/health/version` after deployment and confirm version `2.10.0`, build `2026-09-18-v2.10.0-scheduler-schema-repair-r4`, `nightly_scheduler_mode=dedicated_worker_expected`, and the latest run date/status.
