...
7. Open `/health/version` after deployment and confirm version `2.8.1`, build `2026-09-02-v2.8.1-insights-period-rag-r10`, and that both scheduler values are `True`.
