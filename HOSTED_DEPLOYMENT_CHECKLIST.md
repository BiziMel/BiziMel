...
7. Open `/health/version` after deployment and confirm version `2.9.0`, build `2026-09-03-v2.9.0-insights-pg-period-r1`, and that both scheduler values are `True`.
