...
7. Open `/health/version` after deployment and confirm version `2.9.1`, build `2026-09-09-v2.9.1-engagement-consistency-r6`, and that both scheduler values are `True`.
