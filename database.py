...
def initialise_database():
    ...
    add_column_if_missing(cursor, "contacts", "contact_status", "TEXT DEFAULT 'Active'")
    add_column_if_missing(cursor, "contacts", "archived", "INTEGER DEFAULT 0")
    add_column_if_missing(cursor, "contacts", "archived_date", "TEXT")
    ...
    add_column_if_missing(cursor, "account_partners", "next_action_date", "TEXT")
    add_column_if_missing(cursor, "account_partners", "next_action_time", "TEXT")
    ...
    add_column_if_missing(cursor, "partner_contacts", "next_action_date", "TEXT")
    add_column_if_missing(cursor, "partner_contacts", "next_action_time", "TEXT")
